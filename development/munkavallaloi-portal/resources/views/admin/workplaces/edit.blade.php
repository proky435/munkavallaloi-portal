...
<div class="py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('Munkahely szerkesztése') }}</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">{{ $workplace->name }} adatainak módosítása</p>
            </div>
        ...
        <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-8">
            <form action="{{ route('admin.workplaces.update', $workplace) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $workplace->name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $workplace->code) }}" required maxlength="10"
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="address" value="{{ old('address', $workplace->address) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="city" id="city" value="{{ old('city', $workplace->city) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="country" id="country" value="{{ old('country', $workplace->country) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $workplace->phone) }}"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $workplace->email) }}"
                    ...
                    <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $workplace->is_active) ? 'checked' : '' }}
