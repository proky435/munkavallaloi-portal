<x-guest-layout>
    ...
    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
        <div class="flex items-start space-x-3">
            ...
            <div>
                <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200 mb-1">Új fiók regisztráció</h3>
                <p class="text-sm text-blue-700 dark:text-blue-300">
                    Hozzon létre új fiókot a munkavállalói portálhoz. Minden mező kitöltése kötelező.
                </p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <select id="workplace_id" name="workplace_id" required
                        class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-colors duration-200">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <a href="{{ route('login') }}" class="w-full flex justify-center py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 transition-all duration-200">
                ...
                {{ __('Már van fiókja? Bejelentkezés') }}
            </a>
        </div>
    </form>
</x-guest-layout>
